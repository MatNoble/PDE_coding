function [ ] = z_mesh( bx, by, N_x, N_y, X, Y, XX, YY, Mesh )
        ...
        if Mesh == 3
            ...
            plot(XX1',YY1','k-'),hold on
            plot(XX1(2:N_y/4,end-1:end)',YY1(2:N_y/4,end-1:end)','r-','linewidth',1.5),hold on
            plot(XX1(end-N_y/4+1:end-1,end-1:end)',YY1(end-N_y/4+1:end-1,end-1:end)','r-','linewidth',1.5),hold on
            plot(XX1(2:end-1,2:end-1),YY1(2:end-1,2:end-1),'rx-','linewidth',1.5,'MarkerSize',10),hold on
            plot(XX1(2:end-1,2:end-1)',YY1(2:end-1,2:end-1)','rx-','linewidth',1.5,'MarkerSize',10),hold on
            ...
            plot(XX2',YY2','k-'),hold on
            plot(XX2(2:end-1,:),YY2(2:end-1,:),'rx-','linewidth',1.5,'MarkerSize',10),hold on
            plot(XX2(2:end-1,:)',YY2(2:end-1,:)','rx-','linewidth',1.5,'MarkerSize',10),hold on
            ...
            plot(XX3',YY3','k-'),hold on
            plot(XX3(2:end-1,:),YY3(2:end-1,:),'rx-','linewidth',1.5,'MarkerSize',10),hold on
            plot(XX3(2:end-1,:)',YY3(2:end-1,:)','rx-','linewidth',1.5,'MarkerSize',10),hold on
            ...
            plot(XX4',YY4','k-'),hold on
            plot(XX4(2:N_y/4,1:2)',YY4(2:N_y/4,1:2)','r-','linewidth',1.5),hold on
            plot(XX4(end-N_y/4+1:end-1,1:2)',YY4(end-N_y/4+1:end-1,1:2)','r-','linewidth',1.5),hold on
            plot(XX4(2:end-1,2:end-1),YY4(2:end-1,2:end-1),'rx-','linewidth',1.5,'MarkerSize',10),hold on
            plot(XX4(2:end-1,2:end-1)',YY4(2:end-1,2:end-1)','rx-','linewidth',1.5,'MarkerSize',10),hold off
